  ...
  useEffect(() => {
    ...
    const drawParticles = (animate: boolean) => {
      ...
      particles.forEach((particle) => {
        ...
        context.fillStyle = `rgba(255, 255, 255, ${Math.min(alpha + 0.08, 0.28)})`;
        context.beginPath();
    ...
    <div ref={rootRef} className="privy-login-background fixed inset-0 overflow-hidden bg-[#0A0B1A]">
      ...
      <style jsx>{`
        ...
        .privy-login-background__wave::before {
          ...
          filter: drop-shadow(0 0 8px rgba(108, 77, 255, 0.42));
        ...
        .privy-login-background__orb--violet {
          ...
          width: 22rem;
          height: 22rem;
          background: radial-gradient(circle, rgba(108, 77, 255, 0.4) 0%, transparent 68%);
        ...
        .privy-login-background__orb--blue {
          ...
          width: 22rem;
          height: 22rem;
          background: radial-gradient(circle, rgba(77, 141, 255, 0.28) 0%, transparent 70%);
        ...
        .privy-login-background__orb--neon {
          ...
          width: 16rem;
          height: 16rem;
          background: radial-gradient(circle, rgba(159, 92, 255, 0.24) 0%, transparent 72%);
